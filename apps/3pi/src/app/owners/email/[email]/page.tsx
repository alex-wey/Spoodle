...
export default function OwnerProfileByEmailPage({ params }: { params: Promise<{ email: string }> }) {
  ...
  useEffect(() => {
    const loadOwnerData = async () => {
      ...
      try {
        ...
        // Load owner data by email
        const ownerResponse = await apiService.getOwnerByEmail(email);
